                ...
                <div class="modal-content">
                    ...
                    <div class="row p-3 ">
                        ...
                        <div class="col-4 flex justify-content-center">
                            <div class="col-12 d-flex justify-content-between  border border-2 ">{{$items->divisi}}
                                <form action="{{route('divisi.destroy', $items->id)}}" method="post" class="text-danger">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <a href="{{ route('lowongan.show',  $item->id)}}" class="text-warning"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
                    ...
                    <div class="col-6 d-flex justify-content-end ">
                        <a href="#" class="text-success"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
