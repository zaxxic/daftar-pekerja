...
<div class="row">
    ...
    <div class="mb-4 d-flex justify-content-end col-md-6 lg-6 mt-3">
        <div>
            <a href="javascript:void(0)" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Tambah Divisi</a>
        </div>
                    ...
                    <form id="createDivisiForm" method="post">
                        ...
                        <div class="modal-body">
                            <div class="d-flex justify-content-center">
                                <input type="text" name="divisi" id="devisi" class="form-control" autofocus placeholder="Masukan Divisi " pattern="[a-zA-Z\s]+" style="width: 95%">
        ...
        <div class="card">
                ...
                <div class="ms-auto">
                    <div class="dropdown dropstart">
                        <a href="#" class="link text-dark" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fs-7">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="text-white" viewBox="0 0 21 21">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li class="d-flex">
                                <a href="{{ route('lowongan.edit', $item->id) }}" class="dropdown-item text-primary">
            ...
            <div class="card-body collapse show">
                <div style="float: right;">
                    ...
                    <h6 class="card-title mb-2 d-flex align-items-center justify-content-center mb-3" style="font-size: 16px;">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-4 d-flex justify-content-end">
                        ...
                        <form action="{{ route('nonactive-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formnonactive-{{ $item->id }}">
                            ...
                            <button type="button" title="nonaktif lowongan" onclick="klikNonaktif('{{ $item->id }}')" style="background: none; border: none; padding: 0;">
                                <span id="formnonactive-icon-{{ $item->id }}" class="text-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" title="nonaktif lowongan">
                                        <path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zM4 12c0-4.42 3.58-8 8-8c1.85 0 3.55.63 4.9 1.69L5.69 16.9A7.902 7.902 0 0 1 4 12zm8 8c-1.85 0-3.55-.63-4.9-1.69L18.31 7.1A7.902 7.902 0 0 1 20 12c0 4.42-3.58 8-8 8z" />
                                    </svg>
                                </span>
                        ...
                        <form action="{{ route('active-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formactive-{{ $item->id }}">
                            ...
                            <button type="button" title="aktif lowongan" onclick="klikAktif('{{ $item->id }}')" style="background: none; border: none; padding: 0;">
                                <span id="formactive-icon-{{ $item->id }}" class="text-success">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" title="aktif lowongan">
                                        <path fill="currentColor" d="M20 12a8 8 0 0 1-8 8a8 8 0 0 1-8-8a8 8 0 0 1 8-8c.76 0 1.5.11 2.2.31l1.57-1.57A9.822 9.822 0 0 0 12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10M7.91 10.08L6.5 11.5L11 16L21 6l-1.41-1.42L11 13.17l-3.09-3.09Z" />
                                    </svg>
                                </span>
