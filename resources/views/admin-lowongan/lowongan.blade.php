...
<div class="row">
    ...
    <div class="d-flex justify-content-end gap-2 col-md-6  ">
        <div>
            <a href="javascript:void(0)" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Tambah Divisi</a>
        </div>
        <div class="modal fade" id="staticBackdrop" tabindex="-1" aria-labelledby="exampleModalLabel1">
                        ...
                        <form id="createDivisiForm" method="post">
                            ...
                            <div class="modal-body">
                                <div class="d-flex justify-content-center">
                                    <input type="text" name="divisi" id="devisi" class="form-control" autofocus placeholder="Masukkan nama divisi " style="width: 95%">
                                </div>
                            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <a href="{{ route('lowongan.show', $item->id) }}" class="text-info"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('lowongan.edit', $item->id) }}" class="text-warning"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
                                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 20h4L18.5 9.5a2.828 2.828 0 1 0-4-4L4 16v4m9.5-13.5l4 4" />
                            </svg></a>
                    </div>
                    <div class="col-6 d-flex justify-content-end ">
                        <form action="{{ route('nonactive-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formnonactive">
                            @csrf
                            @method('PATCH')
                            <button type="button" style="background: none; border: none; padding: 0;" class="text-danger" onclick="klikNonaktif()" id="nonaktif">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16m-10 4v6m4-6v6M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-12M9 7V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3" />
                                </svg>
                            </button>
                        </form>
                        <form action="{{ route('active-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formactive">
                            @csrf
                            @method('PATCH')
                            <button type="button" style="background: none; border: none; padding: 0;" class="text-success" onclick="klikAktif()" id="aktif">
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <a href="{{ route('lowongan.show', $item->id) }}" class="text-info"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M12 6.5a9.77 9.77 0 0 1 8.82 5.5c-1.65 3.37-5.02 5.5-8.82 5.5S4.83 15.37 3.18 12A9.77 9.77 0 0 1 12 6.5m0-2C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zm0 5a2.5 2.5 0 0 1 0 5a2.5 2.5 0 0 1 0-5m0-2c-2.48 0-4.5 2.02-4.5 4.5s2.02 4.5 4.5 4.5s4.5-2.02 4.5-4.5s-2.02-4.5-4.5-4.5z" />
                            </svg></a>
                        <a href="{{ route('lowongan.edit', $item->id) }}" class="text-warning"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24">
                                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 20h4L18.5 9.5a2.828 2.828 0 1 0-4-4L4 16v4m9.5-13.5l4 4" />
                            </svg></a>
                    </div>
                    <div class="col-6 d-flex justify-content-end ">
                        <form action="{{ route('nonactive-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formnonactive">
                            ...
                            <button type="button" style="background: none; border: none; padding: 0;" class="text-danger" onclick="klikNonaktif()" id="nonaktif">
                                ...
                                </svg> 2 0 0 0 2 2h8a2 2 0 0 0 2-2l1-12M9 7V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3" />
                                </svg>
                            </button>
                        </form>
                        <form action="{{ route('active-lowongan', $item->id) }}" method="POST" style="display: inline;" id="formactive">
        ...
        $(document).on('click', '.btn-delete', function() {
            ...
            function klikHapus() {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    text: "Anda ingin menghapus Divisi ini!",
                    type: "warning",
                    ...
                    if (result.value) {
                        ...
                        swalWithBootstrapButtons.fire(
                            "Batal",
                            "Selamat divisi tersebut masih selamat. :)",
                            "error"
                        );
                    }
                });
...
<script>
    ...
    ' }}'; // Ganti dengan status sebenarnya dari data
