    ...
    <nav class="navbar navbar-expand-xl navbar-light container-fluid px-0">
        ...
        <ul class="navbar-nav quick-links d-none d-xl-flex">
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('dashboard-user') ? 'active' : '' }}" href="{{ route('dashboard-user') }}">Dashboard</a>
            </li>
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('profile') ? 'active' : '' }}" href="{{ route('profile') }}">Profile</a>
            </li>
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('lowongan-user') ? 'active' : '' }}" href="{{ route('lowongan-user') }}">Lowongan</a>
            </li>
        </ul>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    ...
                                    <div style="width: 35px; height: 35px; border-radius: 50%; overflow: hidden; text-align: center; vertical-align: middle; line-height: 35px;">
                                        <img src="{{ asset('foto_user/default/default.png')}}" style="max-width: 100%; max-height: 100%; vertical-align: middle;" alt="" />
                                    </div>
                                    @else
                                    <div style="width: 35px; height: 35px; border-radius: 50%; overflow: hidden; text-align: center; vertical-align: middle; line-height: 35px;">
