<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar"
    ...
    <nav class="sidebar-nav scroll-sidebar">
        <div class="offcanvas-header justify-content-between">
            <img width="200" src="{{ asset('assets/hummatech.png') }}" alt="" class="img-fluid">
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body profile-dropdown mobile-navbar" data-simplebar="" data-simplebar>
            <ul id="sidebarnav">
                <li class="sidebar-item">
                    <a class="sidebar-link nav-link {{ request()->routeIs('dashboard-admin') ? 'active' : '' }}"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link nav-link {{ request()->routeIs('approval') ? 'active' : '' }}"
                        href="{{ route('approval') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                <path fill="currentColor"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link nav-link {{ request()->routeIs('pekerja') ? 'active' : '' }}"
                        href="{{ route('pekerja') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                <path fill="currentColor"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link nav-link {{ request()->routeIs('pekerja-ditolak') ? 'active' : '' }}"
                        href="{{ route('pekerja-ditolak') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                <path fill="currentColor"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link nav-link {{ request()->routeIs('lowogan.index') ? 'active' : '' }}"
                        href="{{ route('lowongan.index') }}" aria-expanded="false">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
                                <path fill="currentColor"
