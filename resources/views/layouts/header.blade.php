<header class="app-header">
    <nav class="navbar navbar-expand-xl navbar-light container-fluid px-0">
        ...
        <ul class="navbar-nav quick-links d-none d-xl-flex">
            ...
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('approval') ? 'active' : '' }}" href="{{ route('approval') }}">Approval</a>
            </li>
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('pekerja') ? 'active' : '' }}" href="{{ route('pekerja') }}">Pekerja</a>
            </li>
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('pekerja-ditolak') ? 'active' : '' }}" href="{{ route('pekerja-ditolak') }}">Pekerja Ditolak</a>
            </li>
            <li class="nav-item dropdown-hover d-none d-xl-block">
                <a class="nav-link {{ request()->routeIs('lowongan.index') ? 'active' : '' }}" href="{{ route('lowongan.index') }}">Lowongan</a>
            </li>
        </ul>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    <div style="width: 35px; height: 35px; border-radius: 50%; overflow: hidden; text-align: center; vertical-align: middle; line-height: 35px;">
                                        <img src="{{ asset('assets/dist/images/profile/user-1.jpg') }}" style="max-width: 110%; max-height: 110%; vertical-align: middle;" alt="" />
                                    </div>
