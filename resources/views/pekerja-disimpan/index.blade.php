                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="" data-lightbox="image-1" data-title="Gambar Profil Anda"
                                                style="border-radius: 50%; overflow: hidden; width: 35px; height: 35px; display: flex; justify-content: center; align-items: center;">
                                                <img src="{{ asset('foto_user/' . $item->User->foto) }}"style=" max-width: 150%; max-height: 150%;"
                                                    alt="" />
                                            </a>
                                            <div class="ms-3">
                                    ...
                                    <td>
                                        <a href="{{ route('user.cv', ['id' => $item->User->id]) }}"
                                            class="btn btn-primary">CV</a>
                                    </td>
                                    <td class="d-flex">
                                        <form action="BatalSimpan/{{ $item->id }}" method="post"
                                            id="BatalSimpan{{ $item->id }}">
                                            @csrf
                                            @method('PATCH')
                                            <button type="button" title="tolak pekerja"
                                                style="background-color: transparent;"
                                                onclick="BatalSimpan({{ $item->id }})">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                    viewBox="0 0 24 24">
                                                    <path fill="none" stroke="#FA896B" stroke-linecap="round"
