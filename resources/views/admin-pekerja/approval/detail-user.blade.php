...
<body>
                            ...
                            <div class="row ">
                                    ...
                                    <div class="modal-dialog modal-fullscreen">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                @else
                                                    <embed src="{{ asset('cv/' . $data->cv) }}" type="application/pdf"
                                ...
                                <div class="col-lg-8 col-md-8 col-12">
                                    <div
                                        ...
                                        <div class="position-relative d-flex  mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-1 me-3" width="25"
                                        ...
                                        <div class="position-relative d-flex mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-1 me-3 alamat"
                                ...
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="text-center mb-3 ms-4 padding">
                                        <a href="{{ route('user.cv', ['id' => $data->id]) }}"
                                            class="btn btn-primary me-2">CV</a>
                                        <a href="{{ route('user.lamaran', ['id' => $data->id]) }}"
                                    ...
                                    @forelse($experience as $key => $item)
                                        <button class="accordion mt-2">
                                            <div class="d-flex">
                                                ...
                                                <span
                                                    class="fs-2 ms-2 me-2 mt-1">{{ \Carbon\Carbon::parse($item->TanggalAwal)->locale('id')->isoFormat('D MMM Y ') }}</span>-
                                                <span
                                                    class="fs-2 ms-2 mt-1">{{ \Carbon\Carbon::parse($item->TanggalAkhir)->locale('id')->isoFormat('D MMM Y ') }}</span>
                                            </div>
                                        </button>
                                ...
                                <div class="card-body p-4">
                                    @forelse ($school as $item)
                                        <div class="mt-2 mb-2 d-flex justify-content-between">
                                            <div class="d-flex">
                                                <div class="me-4"
                                                    style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden; text-align: center; vertical-align: middle; line-height: 35px;">
                                                    <img src="{{ asset('assets/user-1.jpg') }}" alt=""
                                                        class="w-100 h-100">
                                                </div>
                                                <div>
                            ...
                            <div class="card position-relative overflow-hidden mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <section class="product">
                                        ...
                                        <button class="pre-btn"><img src="{{ asset('images/arrow.png') }}"
                                                alt=""></button>
                                        <button class="nxt-btn"><img src="{{ asset('images/arrow.png') }}"
                                                alt=""></button>
                ...
                <div class="col-lg-4">
                    <div class="col-lg-12">
                        <div class="card mb-4" style="height: auto;">
                                    ...
                                    <div style="float: right;">
                                        @if ($item->status === 'menunggu')
                                            <button class="btn btn-danger me-2" data-bs-toggle="modal"
                                                data-bs-target="#reject-user-{{ $item->id }}">Tolak</button>
                                            <button class="btn btn-success" data-bs-toggle="modal"
                                                data-id="{{ $data->id }}"
                                                data-bs-target="#acc-user-{{ $item->id }}">Terima</button>
                                        @elseif ($item->status === 'diterima')
                                            <form action="{{ route('pekerja-lulus', $item->id) }}" method="POST"
                                                style="display: inline;" class="dropdown-item"
                                                id="formlulus-{{ $item->id }}">
                                                @csrf
                                                @method('PATCH')
                                                <button type="button" class="btn btn-success"
                                                    onclick="klikLulus('{{ $item->id }}')">Lulus</button>
                                            </form>
                                            <button class="btn btn-danger me-2" data-bs-toggle="modal"
                                                data-bs-target="#nonaktif-user-{{ $item->id }}">Gagal</button>
                                        @elseif ($item->status === 'lulus')
                                            <button class="btn btn-danger me-2" data-bs-toggle="modal"
                                                data-bs-target="#pecat-user-{{ $item->id }}">Pecat</button>
                                        @endif
                                    </div>

                            </div>
                            <div class="modal fade" id="acc-user-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">

                                    <form action="{{ route('acc', ['id' => $item->id]) }}" method="POST"
                                        id="pesanTerima{{ $item->id }}">
                                        @method('PATCH')
                                        @csrf
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <span style="color: black;" for="recipient-name"
                                                        class="control-label">Apakah anda
                                                        yakin untuk menerima
                                                        {{ $item->name }}?</span>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="recipient-name" class="control-label"
                                                        style="color: black;">Tanggal Wawancara
                                                        <span style="color: red;">*</span></label>
                                                    <input type="datetime-local" class="form-control"
                                                        id="tanggal{{ $item->id }}" name="tanggal_wawancara" />
                            ...
                            <div class="modal fade" id="reject-user-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex align-items-center">
                            ...
                            <div class="modal fade" id="pecat-user-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex align-items-center">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="/pecat/{{ $item->id }}" method="POST"
                                                style="display: inline;" class="dropdown-item">
                                                @method('PATCH')
                                                @csrf
                                                <div class="mb-3">
                            ...
                            <div class="modal fade" id="nonaktif-user-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header d-flex align-items-center">
                                        ...
                                        <div class="modal-body">
                                            <span for="recipient-name" class="control-label">Apakah anda
                                                ...
                                                {{ $item->name }} untuk mendaftar di lowongan
                                                {{ $item->Vacancy->judul }}?</span>
                                            <form action="/nonactive/{{ $item->id }}" method="POST"
                                                id="pesanNonaktif{{ $item->id }}">
                                                @method('PATCH')
                                                @csrf
                                                <div class="mb-3 mt-2">
                                                    <label for="message-text" style="color: black;"
                                                        class="control-label">Pesan
                                                        <span style="color: red;">*</span></label>
                                                    <textarea class="form-control" id="pesan{{ $item->id }}" placeholder="Masukkan pesan" name="pesan"></textarea>
                                            ...
                                            <div style="width: 100%; overflow:hidden">
                                                <div class="w-full d-flex justify-content-between">
                                                    <span for="exampleInputPassword1"
                                                        class="form-label fw-semibold">{{ $data->User->name }}</span>
                                                    <a href="{{ route('detail-user', $data->User->id) }}"
                                                        class="d-flex items-center" style="padding: 0;">
    ...
    <script>
        ...
        function Nonaktif(itemId) {
            ...
            var pesan = document.getElementById('pesan' + itemId).value;
            const error = document.getElementById('error' + itemId);
            if (pesan.trim() !== "") {
                error.innerHTML = '';
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    .then((result) => {
                        if (result.value) {
                            ...
                            var form = document.getElementById("pesanNonaktif" + itemId); // Menggunakan itemId
                            form.submit();
                        } else if (result.dismiss === Swal.DismissReason.cancel) {
                            swalWithBootstrapButtons.fire(
                                "Batal",
