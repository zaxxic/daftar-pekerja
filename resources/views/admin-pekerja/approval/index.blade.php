...
@section('content')
                        ...
                        <tbody>
                            @forelse ($user as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.cv', ['id' => $row->User->id]) }}"
                                            class="btn btn-primary">CV</a>
                                    </td>
                                    <td>
                                        <a href="{{ route('user.lamaran', ['id' => $row->User->id]) }}"
                                    ...
                                    <td>
                                        <div class="dropdown dropstart">
                                            <a href="#" class="link text-dark" id="dropdownMenuButton"
                                                ...
                                                style="border: 1px solid black; border-radius:50px; padding-top:7px; padding-bottom:7px">
                                                <i class="fs-7">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                        class="text-black" viewBox="0 0 21 21">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="d-flex " style="cursor: pointer;">
                                                    @if ($row->status2 === 'save')
                                                        <form action="BatalSimpan/{{ $row->id }}" method="post"
                                                    ...
                                                    @else
                                                        <form action="save/{{ $row->id }}" method="post"
                                                            id="Simpan{{ $row->id }}"
    ...
    @foreach ($user as $item)
        ...
        <div class="modal fade" id="detail-user-{{ $item->User->id }}" tabindex="-1"
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        <div class="row mb-4">
                                                            <span class="col-12 col-md-3 text-detail  "
                                                                style="font-weight: bold">Nama</span>
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->User->name }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        ...
                                                        <div class="row  mb-4">
                                                            ...
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->User->jenis_kelamin }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        ...
                                                        <div class="row  mb-4">
                                                            <span class="col-12 col-md-3 text-detail "
                                                                style="font-weight: bold">No Telp</span>
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->User->no_telp }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        <div class="row mb-4">
                                                            ...
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->User->email }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        ...
                                                        <div class="row  mb-4">
                                                            <span class="col-12 col-md-3 text-detail "
                                                                style="font-weight: bold">Divisi</span>
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->Vacancy->Division->divisi }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                        ...
                                                        <div class="row  mb-4">
                                                            <span class="col-12 col-md-3 text-detail "
                                                                style="font-weight: bold">Posisi</span>
                                                            <span class="titik-dua col-1">:</span>
                                                            <span
                                                                class="col-12 col-md-8 text-detail">{{ $item->Vacancy->pekerja }}</span>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-12 col-md-12 col-sm-12 pt-3">
                                                        <div class="row mb-4">
                                                            <span class="col-12 text-center text-detail "
                                                                style="font-weight: bold"
                                                                style="font-weight: bold">Alamat</span>

                                                            <span
                                                                class="col-12 text-center text-detail">{{ $item->User->alamat }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal fade" id="detail-cv-{{ $item->User->id }}" tabindex="-1"
            aria-labelledby="detail-cv-{{ $item->User->id }}" aria-hidden="true">
            <!-- Konten modal CV -->
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <embed src="{{ asset('cv/' . $item->User->cv) }}" type="application/pdf" width="100%"
                            height="100%">
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="detail-lamaran-{{ $item->User->id }}" tabindex="-1"
            aria-labelledby="detail-lamaran-{{ $item->User->id }}" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title h4" id="exampleModalFullscreenLabel">
                    ...
                    <div class="modal-body">
                        <embed src="{{ asset('lamaran/' . $item->User->lamaran) }}" type="application/pdf"
