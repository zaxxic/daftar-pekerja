                        ...
                        <div id="detail-user-{{ $row->User->id }}" class="modal fade" tabindex="-1" aria-labelledby="bs-example-modal-md" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    ...
                                    <td>
                                        <a href="{{ route('user.cv', $row->User->id) }}" target="_blank"
                                            class="btn btn-primary" target="_blank">CV</a>
                                    </td>
                                    <td>
                                        <a href="{{ route('user.lamaran', $row->User->id) }}" target="_blank"
                                            class="btn btn-primary" target="_blank">Lamaran</a>
                                    </td>
                                    <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="acc-user-{{ $row->User->id }}" tabindex="-1"
                                                ...
                                                <form action="/acc/{{ $row->User->id }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <span style="color: black;" for="recipient-name"
                                                            class="control-label">Apakah anda yakin untuk menerima pekerja
                                                            tersebut?</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="recipient-name" class="control-label"
                                                            style="color: black;">Tanggal <span
                                ...
                                <div class="modal fade" id="reject-user-{{ $row->User->id }}" tabindex="-1"
                                    aria-labelledby="exampleModalLabel1">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header d-flex align-items-center">
                                                ...
                                                <form action="/reject/{{ $row->User->id }}" method="POST">
                                                    ...
                                                    <td>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="22"
                                                            height="21" viewBox="0 0 16 16" data-bs-toggle="modal"
                                                            data-bs-target="#reject-user-{{ $row->User->id }}">
                                                            <g fill="#FA896B">
                                                                <path
                                                                    d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                            height="28" viewBox="0 0 16 16" data-bs-toggle="modal"
                                                            data-id="{{ $row->User->id }}"
                                                            data-bs-target="#acc-user-{{ $row->User->id }}">
                                                            <g fill="#13DEB9">
                                                                <path
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="35"
                                                            height="25" viewBox="0 0 16 16" data-bs-toggle="modal"
                                                            data-bs-target="#detail-user-{{ $row->User->id }}">
                                                            <g fill="#5D87FF">
                                                                <path
                                                                    d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="acc-user-{{ $row->User->id }}"
                                                                    ...
                                                                    <form action="/acc/{{ $row->User->id }}"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <span style="color: black;"
                                                                                for="recipient-name"
                                                                                class="control-label">Apakah anda yakin
                                                                                untuk menerima pekerja tersebut?</span>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <br>
                                                                            <small id="name"
                                                                                class="form-text text-muted">Setelah anda
                                                                                yakin ingin menerima pekerja tersebut, anda
                                                                                bisa mengirimkan tanggal untuk jadwal
                                                                                wawancara si pekerja.</small>
                                                        ...
                                                        <div id="detail-user-{{ $row->User->id }}" class="modal fade"
                                                            tabindex="-1" aria-labelledby="bs-example-modal-md"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header d-flex align-items-center">
                                                                    ...
                                                                    <div class="modal-body col-lg-12">
                                                                        <div class="d-flex">
                                                                            <div class="col-lg-4">
                                                                                <img src="{{ asset('storage/public/foto_user/' . $row->User->foto) }}"
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                <div class="card">
                                                                                    <div class="card-body">
                                                                                        <h5 class="mb-3">Data Diri
                                                                                            Pekerja</h5>
                                                                                        <div class="d-flex mb-1">
                                                                                            <span class="me-3"
                                                                                                style="font-weight: 600;">Nama
                                                                                                :</span>
                                                                                            <span>{{ $row->User->name }}</span>
                                                                                        </div>
