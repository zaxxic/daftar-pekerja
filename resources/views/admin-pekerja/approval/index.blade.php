                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" title="tolak pekerja" style="background-color: transparent;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" title="Tolak Pekerja" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#reject-user-{{ $row->User->id }}" class="me-1">
                                        <g fill="#FA896B">
                                ...
                                <button type="button" title="terima pekerja" style="background-color: transparent;">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                                <div class="card-body">
                                    ...
                                    <table class="text-nowrap customize-table mb-0 align-middle">
                                        <tr>
                                            <td class="fw-bold" style="padding-right: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Nama <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-right: 250px; border-bottom: 1px solid #cfd4d1;">{{ $item->User->name }}</td>
                                            <td class="fw-bold" style="padding-right: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Email <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-right: 80px; border-bottom: 1px solid #cfd4d1;">{{ $item->User->email }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold" style="padding-right: 10px; padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Jenis Kelamin <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-top: 10px; padding-right: 10px; border-bottom: 1px solid #cfd4d1;">{{ $item->User->jenis_kelamin }}</td>
                                            <td class="fw-bold" style="padding-right: 10px; padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Divisi <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px solid #cfd4d1;">{{ $item->Vacancy->Division->divisi }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold" style="padding-right: 10px; padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">No. Telp <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px solid #cfd4d1;">{{ $item->User->no_telp }}</td>
                                            <td class="fw-bold" style="padding-right: 10px; padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Posisi <span style="float: right;">:</span></td>
                                            <td style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px solid #cfd4d1;">{{ $item->Vacancy->pekerja }}</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold" style="padding-right: 10px; padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #cfd4d1;">Alamat <span style="float: right;">:</span></td>
                                            <td colspan="3" style="border-bottom: 1px solid #cfd4d1; padding-top: 10px;">{{ $item->User->alamat }}</td>
                                        </tr>
                                    </table>
                                    </div>
