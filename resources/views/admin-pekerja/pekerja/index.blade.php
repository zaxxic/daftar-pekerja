                            ...
                            <td>
                                <div class="dropdown dropstart" style="margin-top: -4px;">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li class="d-flex" data-bs-toggle="modal" data-bs-target="#nonaktif-user-{{ $row->id }}" style="cursor: pointer;">
                                            <a class=" text-primary " style="padding: 10px;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 16 16"  class="me-1">
                                                    <g fill="currentColor">
                                        ...
                                        <li class="d-flex" data-bs-toggle="modal" data-id="{{ $row->id }}" data-bs-target="#acc-user-{{ $row->id }}" style="cursor: pointer;">
                                            <a class=" text-primary " style="padding: 10px;">
                                                <form action="{{ route('pekerja-lulus', $row->id) }}" method="POST" style="display: inline;" class="dropdown-item p-0" id="formlulus-{{ $row->id }}">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="button" title="terima pekerja" onclick="klikLulus('{{ $row->id }}')" style="background-color: transparent;">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-1 text-primary" width="25" height="28" viewBox="0 0 16 16" data-bs-toggle="modal" data-id="{{ $row->id }}" data-bs-target="#acc-user-{{ $row->id }}">
                                                            <g fill="currentColor">
