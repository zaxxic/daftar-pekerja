                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-4 col-12 foto">
                                        <div class="justify-content-center align-items-center foto" style="border-radius: 50%; overflow: hidden; width: 180px; height: 180px;">
                                            <img src="{{ asset('foto_user/' . $row->User->foto) }}" style="max-width: 100%; max-height: 100%;" alt="" />
                                        </div>
                                    </div>
