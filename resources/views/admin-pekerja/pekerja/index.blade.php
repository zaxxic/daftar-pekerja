        ...
        <div class="card w-100 position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                    ...
                    <div class="mb-3 d-flex justify-content-end col-md-6 lg-6 mt-3">
                        <form id="form_filter">
                            <div class="mb-3 d-flex align-items-center justify-content-end">
                                ...
                                <button class="btn btn-primary ms-3" style="height: 4%; width: 20%; margin-top: 20px;"
                                    ...
                                    <td>
                                        <button type="button" title="nonaktif pekerja"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21"
                                                ...
                                                data-bs-target="#nonaktif-user-{{ $row->id }}" class="me-1">
                                                <g fill="#FA896B">
                                                    <path
                ...
                @foreach ($user as $item)
                    <div class="modal fade" id="detail-user-{{ $item->id }}" tabindex="-1"
                                                        ...
                                                        <div class="">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                                    ...
                                                                    <div class="row  mb-4">
                                                                        <span class="col-12 col-md-3 text-detail "
                                                                            style="font-weight: bold">Tanggal
                                                                            Wawancara</span>
                                                                        <span class="titik-dua col-1">:</span>
                                                                        <span
                                                                            class="col-12 col-md-8 text-detail">{{ $item->User->tanggal_wawancara }}</span>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-6 col-md-12 col-sm-12 pt-3">
                                                                    ...
                                                                    <div class="row  mb-4">
                                                                        <span class="col-12 col-md-3 text-detail "
                                                                            style="font-weight: bold">Lokasi
                                                                            Wawancara</span>
                                                                        <span class="titik-dua col-1">:</span>
                                                                        <span
                                                                            class="col-12 col-md-8 text-detail">{{ $item->User->lokasi_wawancara }}</span>
                                                                    </div>
