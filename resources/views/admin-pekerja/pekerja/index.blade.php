                    ...
                    <table class="table border text-nowrap customize-table mb-0 align-middle">
                        ...
                        <tbody>
                            @forelse ($user as $row)
                                <tr>
                                    ...
                                    <td>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="26"
                                            ...
                                            data-bs-target="#nonaktif-user-{{ $row->id }}">
                                            <g fill="#FA896B">
                                                <path
                                ...
                                <div class="modal fade" id="nonaktif-user-{{ $row->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/nonactive/{{ $row->id }}" method="POST"
                                                    id="formnonactive">
                                                    @method('PATCH')
                                                    @csrf
                                                    <div class="mb-3">
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header d-flex align-items-center">
                                                ...
                                                <div class="modal fade" id="nonaktif-user-{{ $row->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <hr style="width: 100%; border-top: 2px solid #000000;"
                                                                class="mt-0">
                                                            <div class="modal-body">
                                                                <form action="/nonactive/{{ $row->id }}"
                                                                    method="POST" id="formnonactive">
                                                                    @method('PATCH')
                                                                    @csrf
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <br>
                                                                        <small id="name"
                                                                            class="form-text text-muted">Masukkan alasan
                                                                            kenapa pekerja tersebut dinonaktifkan.</small>
                                                                    </div>
                                                                    <hr style="width: 100%; border-top: 2px solid #000000;"
                                                                        class="mt-0">
