                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex justify-content-between">
                                            <a href="index-2.html" class="text-nowrap logo-img d-block mb-5 w-100" style="margin-top: -8px;">
                                ...
                                <form action="{{ route('register-store') }}" method="POST" enctype="multipart/form-data" id="form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" id="" cols="10" rows="5" class="form-control @error('alamat') is-invalid @enderror" value="{{ old('alamat') }}" id="alamat" name="alamat"></textarea>
                                        @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control @error('cv') is-invalid @enderror" value="{{ old('cv') }}" id="cv" name="cv" aria-describedby="emailHelp" aria-label="Pilih Berkas CV" />
                                        @error('cv')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="d-flex col-lg-12 justify-content-between">
                                        <div class="mb-3 col-lg-5">
                                            ...
                                            <input type="file" class="form-control @error('lamaran') is-invalid @enderror" value="{{ old('lamaran') }}" id="lamaran" name="lamaran" aria-describedby="emailHelp" />
                                            @error('lamaran')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-4 col-lg-5">
                                            ...
                                            <input type="file" class="form-control @error('foto') is-invalid @enderror" value="{{ old('foto') }}" id="foto" name="foto" aria-describedby="emailHelp" />
                                            @error('foto')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
