                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index-2.html" class="text-nowrap logo-img d-block mb-5 w-100">
                                    <img src="{{ asset('assets/dist/images/hummas.png') }}" width="200" alt="" />
                                </a>
                                ...
                                <form action="{{ route('register.store') }}" method="POST">
                                    ...
                                    <div class="d-flex col-lg-12 justify-content-between">
                                        <div class="mb-3 col-lg-5">
                                            <label for="name" class="form-label">Nama Pekerja <span style="color: red;">*</span></label>
                                    ...
                                    <div class="d-flex col-lg-12 justify-content-between">
                                        <div class="mb-3 col-lg-5">
                                            ...
                                            <input type="number" class="form-control" id="no_telp" name="no_telp" aria-describedby="emailHelp" />
                                            @error('no_telp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-lg-5">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <input class="text-sm me-1" type="radio" name="jenis_kelamin" id="radio1" value="laki-laki">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" id="" cols="10" rows="5" class="form-control" id="alamat" name="alamat"></textarea>
                                        @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Masukkan CV <span style="color: red;">*</span></label>
                                        <input type="file" class="form-control" id="cv" name="cv" aria-describedby="emailHelp" aria-label="Pilih Berkas CV" />
                                        @error('cv')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="d-flex col-lg-12 justify-content-between">
                                        <div class="mb-3 col-lg-5">
                                            <label for="exampleInputEmail1" class="form-label">Masukan Lamaran Kerja <span style="color: red;">*</span></label>
                                            <input type="file" class="form-control" id="lamaran" name="lamaran" aria-describedby="emailHelp" />
                                            @error('lamaran')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-4 col-lg-5">
                                            <label for="exampleInputEmail1" class="form-label">Masukan Foto Anda <span style="color: red;">*</span></label>
                                    ...
                                    <div class="d-flex col-lg-12 justify-content-between">
                                        ...
                                        <div class="mb-3 col-lg-5">
                                            ...
                                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" aria-describedby="emailHelp" />
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 py-2 mb-4 rounded-2">Daftar Sekarang</button>
                                    <div class="d-flex align-items-center">
