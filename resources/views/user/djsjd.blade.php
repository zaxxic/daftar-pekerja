                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row ">
                                ...
                                <div class="modal-dialog modal-fullscreen">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @else
                                            <div class="text-center" id="pdf-container-cv">
                                ...
                                <div class="modal-dialog modal-fullscreen">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @else
                                            <div class="text-center" id="pdf-container-lamaran">
                                                <!-- PDF content will be loaded here -->
                                            </div>
                                            @endif
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-4 ">
                                <div style="width: 40px; height: 40px; background-color: #5d87ff; border-radius: 50%; display: flex; align-items: center; justify-content: center; float: right;" class="mt-4 me-4">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Keahlian Anda">{{ old('deskripsi') }}</textarea>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea type="text" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Keahlian Anda">{{ $item->deskripsi }}</textarea>
                                            ...
                                            <div style="background-color: white; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
                                                <p style="margin-top: 4px">
                                                    @if ( $item->Tingkatan === 'SMA/SMK/Sederajat')
                                                        SMA
                                                    @elseif ($item->Tingkatan === 'Universitas')
                                                        UN
                                                    @else
                                                    {{$item->Tingkatan}}
                                                    @endif
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <small id="name" class="form-text text-muted">Silakan masukkan judul
