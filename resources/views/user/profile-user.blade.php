...
<body>
    ...
    <div class="container-fluid">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-0">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-12 container">
                                    <div class="text-center mb-3">
                                        <div style="float: right;" class="mb-3 me-5">
                                            <button class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#detail-cv-{{ Auth()->User()->cv }}">CV</button>
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detail-lamaran-{{ Auth()->User()->lamaran }}">Lamaran</button>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-7">
                <div class="card position-relative overflow-hidden mb-4" style="height: 94%;">
                    ...
                    <div class="card-body p-4">
                        ...
                        @else
                        <di v class="col-lg-12 mt-3 ml-5 text-center" id="lowongan">
                            <img src="{{ asset('assets/nodatas.png') }}" alt="" width="200px">
                        </di>
                        @endif
                    </div>
        ...
        <style>
            .servitikat {
                width: 100%;
                /* Anda bisa mengganti nilai ini sesuai kebutuhan Anda */
                overflow-x: auto;
                /* Mungkin perlu mengatur overflow-x menjadi auto untuk scrolling horizontal jika kontennya melebihi lebar */
                overflow-y: hidden;
                white-space: nowrap;
                display: flex;
            }
                                            ...
                                            <div class="dropdown dropstart">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="new">
                                                    ...
                                                    <form action="{{ route('certificate-delete', $item->id) }}" method="POST" id="formsertifikat-{{$item->id}}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <li><a class="dropdown-item" href="#" onclick="Sertifikat({{$item->id}})">Hapus</a>
                                                        </li>
                                                    </form>
                                                </ul>
                                            </div>
