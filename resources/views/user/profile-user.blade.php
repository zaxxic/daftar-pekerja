                                        ...
                                        <div class="modal-body" style="max-height: 490px; overflow-y: auto;">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="JenisPekerjaan"
                                                    value="{{ old('JenisPekerjaan') }}"></input>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Jenis Pekerjaan<span
                                                            style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="JenisPekerjaan"
                                                        value="{{ $item->JenisPekerjaan }}"></input>
                                                    ...
                                                    <br>
                                                    <div class="mb-3"
                                                        style="width: 250px; height: 150px; border: 1px solid #adadac; overflow: hidden; position: relative; border-radius: 10px;">
                                                        <a href="{{ asset('pengalaman/' . $item->Bukti) }}"
                                                            data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                            <img src="{{ asset('pengalaman/' . $item->Bukti) }}"
                                                                style="width: 100%; height: 100%; object-fit: contain;"
                                                    ...
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Bukti<span
                                                            style="color: red;">*</span></label>
                                                    <input type="file" class="form-control" name="Bukti"
                                                        value="{{ $item->Bukti }}"></input>
                                                    <br>
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Detail Project<span
                                                            style="color: red;">*</span></label>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <textarea type="text" class="form-control" name="deskripsi_keahlian"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-3"
                                                        style="width: 250px; height: 150px; border: 1px solid #adadac; overflow: hidden; position: relative; border-radius: 10px;">
                                                        <a href="{{ asset('sertifikat/' . $item->foto) }}"
                                                            data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                            <img src="{{ asset('sertifikat/' . $item->foto) }}"
                                                                style="width: 100%; height: 100%; object-fit: contain;"
                                                                alt="" />
                ...
                <div class="col-lg-4">
                    <div class="col-lg-12">
                        <div class="card mb-4" style="height: auto;">
                            <div class="card-header bg-info d-flex align-items-center">
                                <h4 class="card-title text-white mb-0">Lowongan Terdaftar</h4>
                            </div>
                            <div class="card-body p-4">
