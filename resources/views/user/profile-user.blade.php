                ...
                <div class="col-lg-8">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row ">
                                        ...
                                        <div class="d-flex ms-3 ms-lg-5 mb-2">
                                            <div class="tepi  d-flex align-items-center justify-content-center rounded-circle"
                                                ...
                                                <div class="  dalam  border border-4 border-white d-flex align-items-center justify-content-center rounded-circle overflow-hidden"
                                                    ...
                                                    <a href="{{ asset('foto_user/' . $user->foto) }}"
                                                        data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                        @if ($user->foto === 'default/default.png')
                                                            <img src="{{ asset($user->foto) }}" alt=""
                                                                class="img-fluid rounded-circle"
                                                                style="width:120px; height:120px; object-fit:cover  ">
                                                        @else
                                                            <img src="{{ asset('foto_user/' . $user->foto) }}"
                                                ...
                                                <div
                                                    style="position: absolute; bottom: 0; right: 0; display: flex; align-items: center; justify-content: center;">
                                                    <div style="width: 40px; height: 40px; background-color: #5d87ff; border-radius: 50%; display: flex; align-items: center; justify-content: center;"
                                                        class="tooltip-container1">
                                                        <form action="{{ route('ubah-foto') }}"
                                                            ...
                                                            <button class="btn btn-primary" type="button" onclick="show()"
                                                                ...
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="mb-3"
                                ...
                                <div class="modal fade" id="detail-cv-{{ Auth()->User()->cv }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header bg-info d-flex align-items-center justify-content-start"
                                                style="border-radius: 10px 10px 0px 0px">
                                                <a type="button" class="text-white mr-2" data-bs-dismiss="modal"
                                                    aria-label="Close">
                                ...
                                <div class="col-lg-4 col-md-4 col-5 ">
                                    <div style="width: 40px; height: 40px; background-color: #5d87ff; border-radius: 50%; display: flex; align-items: center; justify-content: center; float: right;"
                                        class="mt-4 buttonEdit">
                                        <div class="tooltip-container">
                                            <a href="" data-bs-toggle="modal"
                                                data-bs-target="#profile-update-{{ $user->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="text-primary"
                                                    style="margin-bottom: 3px;" width="25" height="25"
                                                    viewBox="0 0 24 24">
                                                    <path fill="#ffffff"
                                ...
                                <div class="modal fade" id="profile-update-{{ $user->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-body" style="max-height: 490px; overflow-y: auto;">
                                                    <div class="mb-3">
                                                        <label for="recipient-name" class="control-label mt-2"
                                                            style="color: black;">Nama<span
                                                                style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" name="name"
                                                            value="{{ $user->name }}"></input>
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-2"
                                                            style="color: black;">No. Telephone<span
                                                                style="color: red;">*</span></label>
                                                        <input type="text" class="form-control" name="no_telp"
                                                            value="{{ $user->no_telp }}"></input>
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-2"
                                                        ...
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-2"
                                                            style="color: black;">Lamaran<span
                                                                style="color: red;">*</span></label>
                                                        <input type="file" class="form-control mb-2" name="lamaran"
                                                            value="{{ $user->lamaran }}"></input>
                                                        <small id="name"
                                                            class="text-muted text-informasi text-white">Format lamaran
                                                            wajib pdf.</small>
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-4"
                                                            style="color: black;">cv<span
                                                                style="color: red;">*</span></label>
                                                        <input type="file" class="form-control mb-2" name="cv"
                                                            value="{{ $user->cv }}"></input>
                                                        <small id="name"
                                                            class="text-muted text-informasi text-white">Format CV wajib
                                                            pdf.</small>
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-4"
                                                        ...
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-2"
                                                            style="color: black;">Profile LinkedIn</label>
                                                        <input type="url" class="form-control mb-2"
                                                            name="url_likedIn" value="{{ $user->LinkedIn }}"></input>
                                                        <small id="name"
                                                            class="text-muted text-informasi text-white">Profile LinkedIn
                                                            tidak wajib diisi.</small>
                                                        <br>
                                                        <label for="recipient-name" class="control-label mt-4"
                                                            style="color: black;">Profile Github</label>
                                                        <input type="url" class="form-control mb-2" name="url_Github"
                                                            value="{{ $user->GitHub }}"></input>
                                                        <small id="name"
                                                            class="text-muted text-informasi text-white">Profile Github
                                                            tidak wajib diisi.</small>
                                                        <br>
                                ...
                                <div class="col-lg-8 col-md-8 col-12">
                                    <div
                                        ...
                                        <div class="position-relative d-flex  mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mb-1 me-3 hilang"
                                                width="25" height="25" viewBox="0 0 24 24">
                                ...
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="text-end mb-3 me-4 padding">
                                        <button class="btn btn-primary me-2" data-bs-toggle="modal"
                                            data-bs-target="#detail-cv-{{ Auth()->User()->cv }}">CV</button>
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#detail-lamaran-{{ Auth()->User()->lamaran }}">Lamaran</button>
                                    </div>
                                </div>
                                <style>
                            ...
                            <div class="card position-relative overflow-hidden mb-4" style="height: 94%;">
                                <div class="card-header bg-info d-flex align-items-center justify-content-between">
                                    ...
                                    <div title="informasi data">
                                        <svg xmlns="http://www.w3.org/2000/svg" data-bs-toggle="modal"
                                            data-bs-target="#informasi" width="32" height="32"
                                            viewBox="0 0 24 24">
                                            <path fill="#ffffff"
                                ...
                                <div class="p-2">
                                    ...
                                    @elseif ($jumlahData >= '2' && $jumlahData < '7')
                                        <span>Sudah lengkap tapi kurang detail</span>
                                    @else
                                        <span>Kurang</span>
                                    @endif
                                ...
                                <div class="modal-body" style="max-height: 490px; overflow-y: auto;">
                                    <div class="mb-3">
                                        ...
                                        <p>Bagian data diri mencakup nama, alamat email, nomor telepon, dan alamat. Selain
                                            itu, Anda juga akan diminta untuk mengunggah CV dan surat lamaran dalam format
                                            PDF sebagai syarat untuk mendaftar pada lowongan pekerjaan. Anda juga dapat
                                            menyertakan tautan ke profil GitHub pribadi dan laman web pribadi Anda.</p>
                                        ...
                                        <p>Foto profil adalah gambar pribadi Anda yang akan digunakan ketika Anda mendaftar
                                            pada lowongan pekerjaan. Pastikan untuk mengunggah foto profil yang sesuai
                                            dengan tuntutan perusahaan.</p>
                                        <p class="bg-info p-2 text-white text-center fs-4 mt-4 mb-4"
                                        ...
                                        <p>Bagian "Tentang Anda" berisi informasi singkat mengenai Anda atau latar belakang
                                            Anda.</p>
                                        ...
                                        <p>"Pengalaman Kerja" berisi informasi mengenai tempat dan waktu pengalaman kerja
                                            ...
                                            selesai, dan juga mengunggah bukti pengalaman dalam format JPG, PNG, atau JPEG.
                                        </p>
                                        ...
                                        <p>"Sertifikat" berisi judul-judul sertifikat yang Anda miliki dan deskripsi tentang
                                            ...
                                            Anda dapat menambahkannya ke profil Anda.</p>
                            ...
                            <div class="card position-relative overflow-hidden mb-4" style="height: 94%;">
                                <div class="card-header bg-info d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-light"
                                        style="margin-bottom: -10px; margin-top: -10px;" data-bs-toggle="modal"
                                        data-bs-target="#modalsummary">{{ $buttonText }}</button>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <small id="name"
                                                    class="text-muted text-informasi text-white">SIlahkan masukkan
                                                    deskripsi Anda.</small>
                                            </div>
                                        </div>

                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success"
                                                onclick="Summary({{ $user->id }})">
                                                Simpan
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card position-relative overflow-hidden mb-4">
                                ...
                                <div class="card-body p-4">
                                    @forelse($experience as $key => $item)
                                        <button class="accordion mt-2" style="border-bottom: 1px solid black"
                                            onclick="Ganti({{ $item->id }})">
                                            <div class="d-flex justify-content-between">
                                                <div class="">
                                                    <p class="fw-semibold fs-4" style="margin: 0">{{ $item->Tempat }}</p>
                                                    <div class="d-flex">
                                                        <span
                                                            class="fs-2 ms-0 me-2 mt-0">{{ \Carbon\Carbon::parse($item->TanggalAwal)->locale('id')->isoFormat('D MMM Y ') }}</span>
                                                        <span class="fs-2 ms-0 me-0 mt-0">-</span>
                                                        <span
                                                            class="fs-2 ms-2 mt-0">{{ \Carbon\Carbon::parse($item->TanggalAkhir)->locale('id')->isoFormat('D MMM Y ') }}</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <svg id="buka{{ $item->id }}" class="buka"
                                                        style="display: block" xmlns="http://www.w3.org/2000/svg"
                                                        width="22" height="22" viewBox="0 0 21 21">
                                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                            stroke-linejoin="round" d="m14.5 8.5l-4 4l-4-4" />
                                                    </svg>

                                                    <svg id="tutup{{ $item->id }}" class="tutup"
                                                        style="display: none" xmlns="http://www.w3.org/2000/svg"
                                                        width="22" height="22" viewBox="0 0 21 21">
                                                        <path fill="none" stroke="currentColor" stroke-linecap="round"
                                                            stroke-linejoin="round" d="m6.5 12.5l4-4l4 4" />
                                                    </svg>
                                                </div>
                                            </div>
                                        </button>
                                        <div class="panel card-body pt-2">
                                            <div class="d-flex mt-3" style="float: right;">
                                                ...
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#experience-update-{{ $item->id }}"
                                                    class="aksi p-1" style="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="" width="23"
                                                ...
                                                <div class="justify-content-end">
                                                    <form action="{{ route('experience-delete', $item->id) }}"
                                                        method="POST" id="formpengalaman-{{ $item->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a type="button" onclick="Pengalaman({{ $item->id }})"
                                                            class="aksi1 p-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="23"
                                                                height="23" style="margin-bottom: 3px;"
                                                                viewBox="0 0 24 24">
                                                                <path fill="currentColor"
                                            ...
                                            <div class="text-center mb-4"
                                                style="width: 670px; height: 500px; border: 1px solid #adadac; overflow: hidden; position: relative; border-radius: 10px;">
                                                <a href="{{ asset('pengalaman/' . $item->Bukti) }}"
                                                    data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                    <img src="{{ asset('pengalaman/' . $item->Bukti) }}"
                                ...
                                <button class="buttonmodal border-bottom-0 border-start-0 border-end-0 w-100"
                                    data-bs-toggle="modal" data-bs-target="#experience-add">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-1" width="25" height="25"
                                        viewBox="0 0 24 24">
                                ...
                                <form action="{{ route('add-experience') }}" method="POST"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="max-height: 490px; overflow-y: auto;">
                                            <div class="mb-3">
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Tempat<span style="color: red;">*</span></label>
                                                <input type="text" class="form-control" name="Tempat"
                                                    value="{{ old('Tempat') }}"
                                                    placeholder="Masukkan Tempat Pengalaman Anda"></input>

                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Jenis Pekerjaan<span
                                                        style="color: red;">*</span></label>
                                                <select name="JenisPekerjaan" class="form-control rounded-1 form-select"
                                                    style="" id="">
                                                    <option value="kontrak"
                                                        {{ 'kontrak' === old('JenisPekerjaan') ? 'selected' : '' }}>kontrak
                                                    </option>
                                                    <option value="permanen"
                                                        {{ 'permanen' === old('JenisPekerjaan') ? 'selected' : '' }}>
                                                        permanen</option>
                                                </select>
                                                ...
                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Nama
                                                    Project<span style="color: red;">*</span></label>
                                                <input type="text" class="form-control" name="NamaProjek"
                                                    value="{{ old('NamaProjek') }}"
                                                    placeholder="Masukkan Nama Projek Anda"></input>

                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Tanggal Awal<span
                                                        style="color: red;">*</span></label>
                                                ...
                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Tanggal Akhir<span
                                                        style="color: red;">*</span></label>
                                                ...
                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Bukti<span style="color: red;">*</span></label>
                                                <input type="file" class="form-control" name="Bukti"
                                                    value="{{ old('Bukti') }}"></input>

                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Detail Project<span
                                                        style="color: red;">*</span></label>
                                                ...
                                                <small id="name" class="text-muted text-informasi text-white">Silakan
                                                    masukkan detail projek yang Anda kerjakan</small>
                                                <br>
                                            </div>
                                        </div>
                        ...
                        @foreach ($experience as $item)
                            <div class="modal fade" id="experience-update-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">

                                    <form action="experience-update/{{ $item->id }}" method="POST"
                                        enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" style="max-height: 490px; overflow-y: auto;">
                                                <div class="mb-3">
                                                    ...
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Jenis Pekerjaan<span
                                                            style="color: red;">*</span></label>
                                                    <select name="JenisPekerjaan" class="form rounded-1 form-control"
                                                        id="tipe">
                                                        <option value="kontrak"
                                                            {{ old('JenisPekerjaan', $item->JenisPekerjaan) == 'kontrak' ? 'selected' : '' }}>
                                                            kontrak</option>
                                                        <option value="permanen"
                                                            {{ old('JenisPekerjaan', $item->JenisPekerjaan) == 'permanen' ? 'selected' : '' }}>
                                                            permanen</option>
                                                    </select>
                                                    @error('tipe')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    ...
                                                    <br>
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Nama Project<span
                                                            style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" name="NamaProjek"
                                                        value="{{ $item->NamaProjek }}"
                                                        placeholder="Masukkan Nama Projek Anda"></input>
                                                    ...
                                                    <div class="mb-3" style="width: 250px; height: 150px; border: 1px solid #adadac; overflow: hidden; position: relative; border-radius: 10px;">
                                                        <a id="image-link" href="{{ asset('pengalaman/' . $item->Bukti) }}" data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                            <img id="preview-image" src="{{ asset('pengalaman/' . $item->Bukti) }}" style="width: 100%; height: 100%; object-fit: contain;" alt="" />
                                                        </a>
                                                    </div>
                                                    <label for="recipient-name" class="control-label mt-2" style="color: black;">Bukti<span style="color: red;">*</span></label>
                                                    <input type="file" class="form-control" name="Bukti" value="{{ $item->Bukti }}" id="bukti-input"></input>
                                                    ...
                                                    <small id="name"
                                                        class="text-muted text-informasi text-white">Silakan masukkan
                                                        detail projek yang Anda kerjakan</small>
                                                    <br>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card position-relative overflow-hidden mb-4">
                                        ...
                                        <div class="d-flex mt-2 mb-2">
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex justify-content-end">
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#skill-update-{{ $item->id }}"
                                                        class="aksi p-1" style="">
                                                    ...
                                                    <form action="skill-delete/{{ $item->id }}" method="POST"
                                                        id="formkeahlian-{{ $item->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a type="button" onclick="Keahlian({{ $item->id }})"
                                                            class="aksi1 p-1">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="23"
                                                                height="23" style="margin-bottom: 3px;"
                                                                viewBox="0 0 24 24">
                                ...
                                <button class="buttonmodal border-bottom-0 border-start-0 border-end-0 w-100"
                                    data-bs-toggle="modal" data-bs-target="#skill-add">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-1" width="25" height="25"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M19 12.998h-6v6h-2v-6H5v-2h6v-6h2v6h6z" />
                                    </svg>
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control mb-2" name="judul"
                                                    value="{{ old('judul') }}"
                                                    placeholder="Masukkan Keahlian Anda"></input>
                                                <small id="name" class="text-muted text-informasi text-white">Silakan
                                                    masukkan judul keahlian Anda.</small>
                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">
                                                    Deskripsi
                                                ...
                                                <textarea type="text" class="form-control mb-2" name="deskripsi_keahlian"
                                                    placeholder="Masukkan Deskripsi Keahlian Anda">{{ old('deskripsi_keahlian') }}</textarea>
                                                <small id="name" class="text-muted text-informasi text-white">Silakan
                                                    masukkan deskripsi keahlian Anda.</small>
                                            </div>
                                        </div>
                        ...
                        @foreach ($skill as $item)
                            <div class="modal fade" id="skill-update-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="judul"
                                                        ...
                                                        placeholder="Masukkan Keahlian Anda"></input>
                                                    <small id="name"
                                                        class="text-muted text-informasi text-white">Silakan masukkan judul
                                                        keahlian Anda.</small>
                                                    <br>
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">
                                                    ...
                                                    <textarea type="text" class="form-control mb-2" name="deskripsi_keahlian"
                                                        placeholder="Masukkan Deskripsi Keahlian Anda">{{ $item->deskripsi }}</textarea>
                                                    <small id="name"
                                                        class="text-muted text-informasi text-white">Silakan masukkan
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card position-relative overflow-hidden mb-4" style="height: 94%;">
                                ...
                                <div class="card-body p-4">
                                    @forelse ($School as $data)
                                        <div class="mt-2 mb-2 d-flex justify-content-between">
                                            <div class="d-flex">
                                                <div class="me-4"
                                                    style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden; text-align: center; vertical-align: center; line-height: 50px; border:1px solid black">
                                                    <div
                                                        style="background-color: white; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">
                                                ...
                                                <div>
                                                    <p for="exampleInputPassword1" class=" fw-semibold"
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="aksi p-1"
                                                    onclick="ShowEditModal({{ $item->id }})" width="30"
                                                    height="30" viewBox="0 0 24 24">
                                                    <path fill="currentColor"
                                                        d="M5 19h1.4l8.625-8.625l-1.4-1.4L5 17.6V19ZM19.3 8.925l-4.25-4.2l1.4-1.4q.575-.575 1.413-.575t1.412.575l1.4 1.4q.575.575.6 1.388t-.55 1.387L19.3 8.925ZM17.85 10.4L7.25 21H3v-4.25l10.6-10.6l4.25 4.25Zm-3.525-.725l-.7-.7l1.4 1.4l-.7-.7Z" />
                                                </svg>
                                                <svg xmlns="http://www.w3.org/2000/svg" class="aksi1 p-1"
                                                    onclick="HapusData({{ $item->id }})" width="30"
                                                    height="30" style="" viewBox="0 0 24 24">
                                                    <path fill="currentColor"
                                                        d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM8 9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4z" />
                                                </svg>
                                            </div>
                                ...
                                <button class="buttonmodal border-bottom-0 border-start-0 border-end-0 w-100"
                                    data-bs-toggle="modal" data-bs-target="#tambah-pendidikan">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-1" width="25" height="25"
                                        viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M19 12.998h-6v6h-2v-6H5v-2h6v-6h2v6h6z" />
                                    </svg>
                        ...
                        <div class="modal fade" id="tambah-pendidikan" tabindex="-1"
                            aria-labelledby="tambah-pendidikan" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('pendidikan') }}" method="post" id="Pendidikan">
                                            ...
                                            <select class="col-12 col-md-12 rounded-1 form-control" onchange="Form()"
                                                ...
                                                <option value="SMA/SMK/Sederajat"
                                                    @if (old('Tingkatan', old('Tingkatan')) == 'SMA/SMK/Sederajat') selected @endif>SMA/SMK/Sederajat
                                                </option>
                                                <option value="Universitas"
                                                    @if (old('Tingkatan', old('Tingkatan')) == 'Universitas') selected @endif>Universitas</option>
                                            </select>
                                            ...
                                            <div class="mt-2" id="NamaSekolah">
                                                ...
                                                <input placeholder="Nama Sekolah"
                                                    class="col-12 col-md-12 rounded-1 form-control" type="text"
                                                    name="NamaSekolah" value="{{ old('NamaSekolah') }}" id="">
                                            </div>
                                            <div class="mt-2">
                                                ...
                                                <input placeholder="Tanggal Awal"
                                                    class="col-12 col-md-12 rounded-1 form-control" type="date"
                                                    name="TanggalAwal" value="{{ old('TanggalAwal') }}" id="">
                                            </div>
                                            <div class="mt-2">
                                                <label for="namaSekolah">
                                                    Tanggal Lulus
                        ...
                        <div class="modal fade" id="edit-pendidikan" tabindex="-1" aria-labelledby="tambah-pendidikan"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" id="Pendidikan">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <input placeholder="Nama Sekolah"
                                                    class="col-12 col-md-12 rounded-1 form-control" type="text"
                                                    name="NamaSekolah" value="" id="Sekolah">
                                            </div>
                                            <div class="mt-2">
                                                <label for="TanggalAwal">Tanggal Awal</label>
                                                <input placeholder="Tanggal Awal"
                                                    class="col-12 col-md-12 rounded-1 form-control" type="date"
                                                    name="TanggalAwal" value="" id="Awal">
                                            </div>
                                            <div class="mt-2">
                                                <label for="TanggalAkhir">Tanggal Lulus</label>
                                                <input placeholder="Tanggal Lulus"
                                                    class="col-12 col-md-12 rounded-1 form-control" type="date"
                                                    name="TanggalAkhir" value="" id="Akhir">
                                            </div>
                                            <div id="Jurusan"></div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Tutup</button>
                                        <button type="button" id="buttonEdit" onclick="EditData()"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card position-relative overflow-hidden mb-4">
                                <div class="card-header bg-info d-flex align-items-center justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-light"
                                        style="margin-bottom: -10px; margin-top: -10px;" data-bs-toggle="modal"
                                        data-bs-target="#certificate-add">Tambah Sertifikat</button>
                                </div>
                                <div class="">
                                                            ...
                                                            <div class="p-2">
                                                                            ...
                                                                            <ul class="dropdown-menu"
                                                                                ...
                                                                                <li class="d-flex">
                                                                                    <a href="#"
                                                                                        ...
                                                                                        data-bs-target="#certificate-update-{{ $item->id }}">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                ...
                                                                                <li class="d-flex">
                                                                                    <form
                                                                                        action="{{ route('certificate-delete', $item->id) }}"
                                                                                        method="POST"
                                                                                        style="display: inline;"
                                                                                        class="dropdown-item"
                                                                                        id="formsertifikat-{{ $item->id }}">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <button type="button"
                                                                                            class=" delete-button me-1 dropdown-item text-primary"
                                                                                            onclick="Sertifikat('{{ $item->id }}')"
                                                                                            style="background: none; border: none; padding: 0;">
                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                class="text-primary me-2"
                                                                                                width="20"
                                                                                ...
                                                                                <li class="d-flex">
                                                                                    <a href="#"
                                                                                        class="dropdown-item text-primary"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#certificate-detail-{{ $item->id }}">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                            class="text-primary me-2"
                                                                                            width="20"
                                                                                            height="20"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12 mb-3">
                                                                        <div class="border border-4 border-white d-flex align-items-center justify-content-center overflow-hidden"
                                                                            style="width: 200px; height: 110px;">
                                                                            <img src="{{ asset('sertifikat/' . $item->foto) }}"
                                                                                alt=""
                                                                    ...
                                                                    <div class="col-12 " style="height: 100px">
                                                                        <span
                                                                            style="color: black">{{ $item->judul }}</span>
                        ...
                        <div class="modal fade" id="certificate-add" tabindex="-1"
                            aria-labelledby="exampleModalLabel1">
                            <div class="modal-dialog" role="document">

                                <form action="{{ route('add-certificate') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-content">
                                        <div class="modal-header d-flex align-items-center">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control mb-2" name="judul"
                                                    value="{{ old('judul') }}" placeholder="Masukkan Judul"></input>
                                                <small id="name"
                                                    class="text-muted text-informasi text-white">Silakan masukkan judul
                                                    sertifikat Anda.</small>
                                                <br>
                                                <label for="recipient-name" class="control-label mt-2"
                                                    style="color: black;">Foto<span style="color: red;">*</span></label>
                        ...
                        @foreach ($certificate as $item)
                            <div class="modal fade" id="certificate-update-{{ $item->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel1">
                                <div class="modal-dialog" role="document">

                                    <form action="certificate-update/{{ $item->id }}" method="POST"
                                        enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="judul"
                                                        value="{{ $item->judul }}"></input>
                                                    <small id="name"
                                                        class="text-muted text-informasi text-white">Silakan masukkan
                                                        judul sertifikat Anda.</small>
                                                    <br>
                                                    <div class="mb-3 mt-3" style="width: 250px; height: 150px; border: 1px solid #adadac; overflow: hidden; position: relative; border-radius: 10px;">
                                                        <a id="foto-link" href="{{ asset('sertifikat/' . $item->foto) }}" data-lightbox="image-1" data-title="Gambar Profil Anda">
                                                            <img id="preview-foto" src="{{ asset('sertifikat/' . $item->foto) }}" style="width: 100%; height: 100%; object-fit: contain;" alt="" />
                                                        </a>
                                                    </div>
                                                    <label for="recipient-name" class="control-label mt-2" style="color: black;">Foto<span style="color: red;">*</span></label>
                                                    <input type="file" class="form-control" name="foto" value="{{ $item->foto }}" id="foto-input"></input>
                            ...
                            <div class="modal fade" id="certificate-detail-{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-body" style="max-height: 80vh; overflow-y: auto;">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="border border-4 border-white d-flex align-items-center justify-content-center overflow-hidden"
                                                    ...
                                                    <img src="{{ asset('sertifikat/' . $item->foto) }}" alt=""
                                                        style="max-height: 100%; width: 100%; border-radius: 20px;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <br>
                                                    <label for="recipient-name" class="control-label mt-2"
                                                        style="color: black;">Foto<span
                                                            style="color: red;">*</span></label>
                                                    <input type="file" class="form-control" name="foto"
                                                        value="{{ $item->foto }}"></input>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                @empty
                                    @if (Auth()->user()->status === 'ditolak')
                                        <div class="" style="padding: 3%;"><span class="mb-2">Anda telah
                                    ...
                                    @elseif (Auth()->user()->status === 'lulus')
                                        @if ($worker->count() > 0)
                                            ...
                                            divisi : {{ $worker->divisi }} <br>
                                            posisi : {{ $worker->posisi }}
                                        @else
                                        ...
                                        <div class="d-flex">
                                            <div>
                                                ...
                                                <p for="exampleInputPassword1" class="mb-2"
                                                    style="margin-bottom: 0">
                                                    Divisi : <span
                                                        style="color: #5d87ff">{{ $data->Division->divisi }}</span>
                                                </p>
                                                <p for="exampleInputPassword1" class="mb-2"
                                                    style="margin-bottom: 0">
                                                    Posisi : {{ $data->pekerja }}
...
<script src="{{ asset('assets/dist/libs/bootstrap-material-datetimepicker/node_modules/moment/moment.js') }}">
    ...
    <script>
        document.getElementById('foto-input').addEventListener('change', function(e) {
            var file = e.target.files[0];
            var image = document.getElementById('preview-foto');
            var imageLink = document.getElementById('foto-link');
            var reader = new FileReader();
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#LihatSelengkapnya').click(function() {
                ...
                var url = "{{route('LihatLowonganAktif')}}";
