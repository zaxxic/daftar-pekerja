                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="name" value="{{ $user->name }}"
                                            class="form-control" id="exampleInputName" placeholder="Mathew Anderson">
                                        @error('name')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input type="email" value="{{ $user->email }}" name="email"
                                            class="form-control" id="exampleInputEmail" placeholder="info@modernize.com">
                                        @error('email')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="no_telp" value="{{ $user->no_telp }}"
                                            class="form-control" id="exampleInputPhone" placeholder="+91 12345 65478">
                                        @error('no_telp')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea name="alamat" class="form-control" id="exampleInputAddress"
                                            placeholder="Jalan Pegangsaan Timur Nomor 14, RT 04 RW 05 Kel. Senayan, Kec. Kebayoran Baru, Jakarta Selatan, 10450">{{ $user->alamat }}</textarea>
                                        @error('alamat')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class=" d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('user.lamaran', $user->id) }}" target="_blank"
                                                class="btn btn-primary" target="_blank">Lihat Lamaran</a>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class=" d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('user.cv', $user->id) }}" target="_blank"
                                                class="btn btn-primary" target="_blank">Lihat CV</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                                    ...
                                    <button class="btn btn-light-danger text-danger"><a
                                            href="{{ route('dashboard-user') }}">Cancel</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
