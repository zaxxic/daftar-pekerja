...
<body>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class=" d-flex justify-content-between">
                                                ...
                                                <a data-bs-toggle="modal"
                                                    ...
                                                    class="btn btn-primary">Lihat Lamaran</a>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <div class=" d-flex justify-content-between">
                                                ...
                                                <a data-bs-toggle="modal"
                                                    ...
                                                    class="btn btn-primary">Lihat CV</a>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                                        ...
                                        <button class="btn btn-light-danger text-danger"><a
                                                href="{{ route('dashboard-user') }}">Kembali</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @else
                        <embed src="{{ asset('cv/' . $user->cv) }}" type="application/pdf" width="100%"
                            height="100%">
                    @endif
                </div>
    ...
    <div class="modal fade" id="detail-lamaran-{{ Auth()->User()->lamaran }}" tabindex="-1"
        aria-labelledby="detail-lamaran-{{ Auth()->User()->cv }}" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @else
                        <embed src="{{ asset('lamaran/' . $user->lamaran) }}" type="application/pdf" width="100%"
                            height="100%">
                    @endif
                </div>
                <div class="modal-footer">
