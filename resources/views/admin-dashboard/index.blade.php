    ...
    <div class="col-11 col-md-5 mx-3  my-2 rounded-2 col-lg-2 col-xl-2 py-3" style="background-color: #E6FFFA">
        <div class="d-flex gap-2">
            <div class="p-1 align-self-center rounded" style="background-color: #13DEB9">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style="color: #ffff;" width="32" height="32" viewBox="0 0 24 24">
        ...
        <div class="d-flex gap-2">
            <div class="p-1 align-self-center rounded" style="background-color: #FA896B">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                    <path fill="currentColor" style="color: #ffff;" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10s10-4.5 10-10S17.5 2 12 2zM4 12c0-4.4 3.6-8 8-8c1.8 0 3.5.6 4.9 1.7L5.7 16.9C4.6 15.5 4 13.8 4 12zm8 8c-1.8 0-3.5-.6-4.9-1.7L18.3 7.1C19.4 8.5 20 10.2 20 12c0 4.4-3.6 8-8 8z" />
                </svg>
            </div>
            <div class="" style="font-size: 15px">
                Status <br> Ditolak
    ...
    <div class="col-11 col-md-5  mx-3  my-2 rounded-2 col-lg-2 col-xl-2 py-3" style="background-color: #E6FFFA">
        <div class="d-flex gap-2">
            <div class="p-1 align-self-center rounded" style="background-color: #67E6E6">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style="color: #ffff;" width="32" height="32" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M14 10H3v2h11v-2zm0-4H3v2h11V6zm4 8v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zM3 16h7v-2H3v2z" />
                </svg>
            </div>
            <div class="" style="font-size: 15px">
                Jumlah <br> Divisi
